      ...
      <div className="container mx-auto px-4 max-w-3xl">
        <AnimateOnScroll>
          <div className="bg-gradient-gold rounded-[40px] p-8 md:p-14 text-center shadow-gold">
            ...
            <a href="#" className="inline-block bg-primary-foreground text-btn-dark font-body font-bold text-xl px-14 py-5 rounded-full hover:scale-105 transition-transform duration-300 shadow-lg animate-pulse-gold">
