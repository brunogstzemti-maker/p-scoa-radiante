      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <AnimateOnScroll delay={100}>
          <div className="glass-pink rounded-[32px] p-8 md:p-12 mb-12">
            ...
            <p className="text-center text-lg font-body text-foreground/80 mb-2">
              com organização e <strong>sem improvisos.</strong>
            </p>
          </div>
        </AnimateOnScroll>

        <AnimateOnScroll delay={200}>
          <p className="text-center text-lg font-body text-foreground/80 mb-8 leading-relaxed">
        ...
        <AnimateOnScroll delay={300}>
          <div className="text-center mb-8">
            <p className="text-xl font-display font-semibold text-foreground mb-6">E o resultado?</p>
        ...
        <AnimateOnScroll delay={400}>
          <div className="bg-card rounded-[32px] p-8 md:p-10 border border-border text-center">
            <p className="text-foreground/70 font-body text-lg mb-6 leading-relaxed">
            ...
            <p className="text-foreground/70 font-body leading-relaxed mb-8">
              A maioria das confeiteiras perde vendas porque gasta tempo demais criando artes, ajustando detalhes e tentando parecer profissional, quando poderia estar focada no que realmente importa: <strong>produzir, vender e lucrar.</strong>
            </p>
            <div className="flex justify-center gap-6 text-2xl font-display font-bold">
